    ...
    <div>
      ...
      <div className="grid grid-cols-3 mx-28 gap-8 mt-5">
        <div className="text-center relative bg-black border-r rounded-lg">
          ...
          <br />
          <h1 className="pt-12 pb-5 font-sans text-white">
            Miễn phí vận chuyển
          </h1>
        </div>
        <div className="text-center relative bg-black border-r rounded-lg">
      ...
      <h1 className="text-3xl uppercase font-barlow font-bold pt-7 pb-5 border-b-2 mb-7 mx-[300px]">
      ...
      <div className="mt-[40px]">
        <a className="border-2 p-2 bg-black text-white rounded-lg hover:bg-white hover:text-black hover:border-black hover:border cursor-pointer">Read more</a>
      </div>
    </div>
  );
};
